...
4. 각 회차가 공백 제외 `{{minimum_chapter_chars_no_space}}`자 이상인지 확인합니다. 미달 회차는 정본 후보에서 강하게 감점하고, 삭제/병합/브리지 필요성을 따로 적습니다.
...
9. 최종적으로 편집에 넘길 항목만 `llm-facing/consistency_report.md`에 요약합니다.
